<?php
namespace PointCheckout\Rewards\Block;
...
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function getPointCheckoutUrl()
    {
        ...
        $order->save();
        return $this->_session->getData('pointcheckoutRedirectUrl').'?returnUrl='.$this->url->getRouteUrl('pointcheckoutreward/payment/confirm');
    }
    ...
    {
        return $this->url->getRouteUrl('pointcheckoutreward/payment/confirm');
    }
